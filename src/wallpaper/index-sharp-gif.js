...
const truefile = path.join(__dirname, 'image.gif');
const tmpfile = path.join(__dirname, 'image.gif.tmp');
const screen = {
  width: 1920,
  height: 1080,
};
...
let fn;
(fn = async () => {
  console.time('wallpaper-sharp-gif');
  ...
  console.timeEnd('wallpaper-sharp-gif');
